...
#define CONFIG_BOARDNAME "P1024WLAN"
...
/* TBD ::chip select 1 doesnt seems to be in use on p1020Wlan */
...
#define CONFIG_SYS_DDR_WRLVL_CONTROL	0x8675f608	/* changed :0x8655A608 */
#define CONFIG_SYS_DDR_SR_CNTR		0x00000000
#define CONFIG_SYS_DDR_RCW_1		0x00000000
#define CONFIG_SYS_DDR_RCW_2		0x00000000

#define CONFIG_SYS_DDR_CONTROL		0xc70c0008	/* changed :0xC70C0000 */	/* Type = DDR3	*/
#define CONFIG_SYS_DDR_CONTROL_2	04401040	/* changed 0x04401050  TBD.*/


#define CONFIG_SYS_DDR_TIMING_4		0x00220001	/* verified as same*/
#define CONFIG_SYS_DDR_TIMING_5		0x03402400	/* verified as same */

#define CONFIG_SYS_DDR_TIMING_3		0x00020000
#define CONFIG_SYS_DDR_TIMING_0		0x00330004	/* verified as same */
#define CONFIG_SYS_DDR_TIMING_1		0x6f6B4846	/* verified as same */
#define CONFIG_SYS_DDR_TIMING_2		0x0FA8C8CF	/* verified as same */
#define CONFIG_SYS_DDR_CLK_CTRL		0x03000000	/* verified as same */

#define CONFIG_SYS_DDR_MODE_1		0x40461520	/* verified as same */
#define CONFIG_SYS_DDR_MODE_2		0x8000c000	/* TBD : not verified yet , looks like not required in wlan */

#define CONFIG_SYS_DDR_INTERVAL		0x0C300000	/* verified as same */
#endif

#undef CONFIG_CLOCKS_IN_MHZ			/* TBD. */



/*
 * Memory map P1020Wlan Board.
 *
 * 0x0000_0000	0x7fff_ffff	DDR			upto 2GB cacheablen (at most)	
 * 0x8000_0000	0xdfff_ffff	PCI Express Mem		1.5G non-cacheable(PCIe * 3)
 *

 * Localbus cacheable
 * 0xf8f8_0000 0xf8ff_ffff	SRAM (L2 cache)		Up to 512K cacheable   < TBD. - should be remapped here >
 ...
 * 0xffa0_0000	0xffaf_ffff	CPLD			1M non-cacheable	<< same as RDB.

 * 0xffc0_0000	0xffc3_ffff	PCI IO range		256k non-cacheable      << same as RDB. 
...
/* 
 *  Memory map(new) for P1020Wlan Board.  		 << similiar as  RDB<< 
 *
 * 0x0000_0000 0x7fff_ffff	DDR			Up to 2GB cacheable
 * 0x8000_0000 0xdfff_ffff	PCI-E Mem		1.5G non-cacheable(PCIe * 3)
 ...
 * 0xff98_0000 0xff98_ffff	PMC			64K non-cacheable	CS2   // TBD
...
#define CONFIG_SPL_RELOC_STACK_SIZE	(32 << 10)						/*32x 2^10 = 32kb */
...
#define CONFIG_RTC_PT7C4338			/* TODO: CONFIG_RTC_DS1339U */
...
#if (defined(CONFIG_TARGET_P1020WLAN) || defined(CONFIG_TARGET_P1020RDB_PD))
#define CONFIG_SYS_MAX_FLASH_SECT	512	/* sectors per device */ /* 64M */
